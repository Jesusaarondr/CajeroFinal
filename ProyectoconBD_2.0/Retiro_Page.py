...
class WithdrawPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        rightframe.pack(fill='y',expand='False',side='bottom')
        ...
        cash=tk.StringVar()
        other_amount_entry=tk.Entry(button_frame,font=('Lucida Console',12),textvariable=cash,width=25,justify='right')
        ...
        Button(self, text="1",width=8,height=5,command=lambda:btnClik(1)).place(x=560,y=250)
        Button(self, text="2",width=8,height=5,command=lambda:btnClik(2)).place(x=640,y=250)
        Button(self, text="3",width=8,height=5,command=lambda:btnClik(3)).place(x=720,y=250)
        
        Button(self, text="4",width=8,height=5,command=lambda:btnClik(4)).place(x=560,y=350)
        Button(self, text="5",width=8,height=5,command=lambda:btnClik(5)).place(x=640,y=350)
        Button(self, text="6",width=8,height=5,command=lambda:btnClik(6)).place(x=720,y=350)

        Button(self, text="7",width=8,height=5,command=lambda:btnClik(7)).place(x=560,y=450)
        Button(self, text="8",width=8,height=5,command=lambda:btnClik(8)).place(x=640,y=450)
        Button(self, text="9",width=8,height=5,command=lambda:btnClik(9)).place(x=720,y=450)

        Button(self, text="0",width=8,height=5,command=lambda:btnClik(0)).place(x=560,y=550)
        Button(self, text="C",width=8,height=5,command=clear).place(x=720,y=550)
